...
public class HermesExtendedBindingProperties implements ExtendedBindingProperties<HermesConsumerProperties, HermesProducerProperties> {
    ...
    private Map<String, HermesBindingProperties> bindings = new HashMap<>();

    public Map<String, HermesBindingProperties> getBindings() {
        return bindings;
    }

    public void setBindings(Map<String, HermesBindingProperties> bindings) {
